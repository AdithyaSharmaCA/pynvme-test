...
Lossless + Named Hierarchy + Contextual SHALL Extraction
"""
...
class OCPSpecificationParser:
    """
    Lossless OCP Parser with LLM-ready contextual requirements
    """

    SECTION_PATTERN = re.compile(r'^(\d+(?:\.\d+)*)(\s+)(.+)$')
    SHALL_PATTERN = re.compile(r'\bshall\b', re.IGNORECASE)
    ANCHOR_PATTERN = re.compile(r'\bsee\s+[^\n.,;]+', re.IGNORECASE)
